    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <motion.button
                ...
                <div className="size-6 rounded-md bg-gray-800/50 p-0.5 group-hover:scale-1100 transition-transform">
                    <Image src={currentLanguageObj.logoPath} width={24} height={24} alt="programming language logo" className="size-full object-contain relative z-10" />
                </div>
                                    ...
                                    >
                                        ...
                                        ${isLocked ? "opacity-50" : "hover:bg-[#262637]"}`}
                                            ...
                                            <div className={`relative size-8 rounded-lg p-1.5 group-hover:scale-110 transition-transform ${language === lang.id ? "bg-blue-500/10" : "bg-gray-800/50"}`}>
                                                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10  opacity-0 group-hover:opacity-100 transition-opacity" />
                                                <Image src={lang.logoPath} alt={`${lang.label} logo`} width={24} height={24} className={`size-full object-contain relative z-10`} />
                                            </div>

                                            <span className="flex-1 text-left group-hover:text-white transition-colors">{lang.label}</span>

                                            {/* selected langugae border */}
                                            {language === lang.id && (
                                                <motion.div
