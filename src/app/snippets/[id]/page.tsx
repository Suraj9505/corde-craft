...
function SnippetDetailPage() {
    ...
    const snippet = useQuery(api.snippets.getSnippetById, { snippetId: id as Id<"snippets"> });
    const comments = useQuery(api.snippets.getComments, { snippetId: id as Id<"snippets"> });
                    ...
                    <div className="bg-[#121218] border border-[#ffffff0a] rounded-2xl p-6 sm:p-8 mb-6 backdrop-blur-xl">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-xl sm:text-2xl font-semibold text-white mb-2 capitalize">
                                        {snippet.title}
                                    </h1>
                                    <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm">
                                        <div className="flex items-center gap-2 text-[#8b8b8d]">
                                            <User className="w-4 h-4" />
                                            <span className="capitalize">{snippet.userName}</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-[#8b8b8d]">
